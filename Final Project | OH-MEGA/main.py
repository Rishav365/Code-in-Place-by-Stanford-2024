...
**Description**:  
OH-MEGA is a multi-functional Python program featuring ten diverse tools and games. Each function is designed to entertain, educate, and provide utility in various aspects. The program includes games, educational quizzes, and calculators. 
...
6. Number Guess Game
7. High-Low Game
8. Planetary Weight Calculator
9. Cat Years Calculator
10. Dog Years Calculator
...
1. Choose a program by entering the corresponding number.
2. Follow the instructions specific to the selected program.
3. After completing a program, decide whether to return to the main menu or exit.

**Example**:
1. To play the Game of Nimm:
   - Select option 5 from the main menu.
   - Choose to play against a friend or the AI.
   - Decide the winning condition (the player who takes the last stone or the one who doesn't).
   - Players take turns removing 1, 2, or 3 stones until no stones are left.
   - The winner is announced based on the chosen rule.

**Additional Information**:
- The program provides feedback and scores in various educational and game modules.
- Designed for entertainment and educational purposes.

P.S. I came up with this idea: why not combine everything I have learned so far into a single "MEGA" program (like literally!)? And thus, OH-MEGA was born! This project represents my attempt to incorporate everything I have learned so far in the Code in Place 2024 course into one "mega" program.
